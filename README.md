...
<p align="center"><img src="docs/images/product-overview.svg" alt="知华科技集成业务计划 IBP产品概览" width="920"></p>

## 企业计划协同画布

IBP 以一份可执行的共识计划为核心，在数量、能力和财务结果之间持续平衡。

ZhuaTech Ibp 是知华科技（**上海如静知华信息科技有限公司**）维护的前后端分离企业应用社区源码版。产品、实施与技术服务信息请访问[知华科技官网](https://www.zhuatech.cn/)。
...
供需净额、产能约束、安全库存、服务水平与利润投影。

- 接口：`POST /api/enterprise/ibp/balance-plan`
...
- 预留 ERP、MES、WMS、CRM 与财务系统 的适配器边界，不包含任何真实密钥
...
Java 工程包：`cn.zhuatech.ibp`。前端默认端口：`8305`。
...
SEO：IBP系统、S&OP、需求计划、供应计划、产销协同、知华科技、上海软件开发、企业信息化、软件项目外包。
